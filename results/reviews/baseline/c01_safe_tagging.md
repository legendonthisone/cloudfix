...
This change adds tags to an existing production S3 bucket and enables versioning on it. Both changes are additive security improvements with no destructive actions or new exposures.
